...
static void test_uleb128_basic() {
    ...
    [[maybe_unused]] uint8_t data[] = {0x3E};
...
static void test_uleb128_multibyte() {
    ...
    [[maybe_unused]] uint8_t data[] = {0xAC, 0x02};
    [[maybe_unused]] size_t offset = 0;
...
static void test_uleb128_large() {
    ...
    [[maybe_unused]] uint8_t data[] = {0xE5, 0x8E, 0x26};
    [[maybe_unused]] size_t offset = 0;
...
static void test_leb128_negative() {
    ...
    [[maybe_unused]] uint8_t data[] = {0xC0, 0xBB, 0x78};
    [[maybe_unused]] size_t offset = 0;
...
static void test_leb128_minus_one() {
    // -1 -> 0x7F
    [[maybe_unused]] uint8_t data[] = {0x7F};
    [[maybe_unused]] size_t offset = 0;
...
static void test_growing_normal() {
    // Normal value: 100
    [[maybe_unused]] uint8_t data[] = {0x64};
    [[maybe_unused]] size_t offset = 0;
...
static void test_growing_sentinel() {
    ...
    [[maybe_unused]] uint8_t data[] = {0xFF, 0xFF, 0xFF, 0x7F, 0x56};
    [[maybe_unused]] size_t offset = 0;
...
static void test_read_u8() {
    [[maybe_unused]] uint8_t data[] = {0x42};
    [[maybe_unused]] size_t offset = 0;
...
static void test_read_u16_le() {
    [[maybe_unused]] uint8_t data[] = {0x34, 0x12};
    [[maybe_unused]] size_t offset = 0;
...
static void test_read_i64_le() {
    ...
    [[maybe_unused]] uint8_t data[] = {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    [[maybe_unused]] size_t offset = 0;
...
static void test_read_f64_le() {
    ...
    [[maybe_unused]] uint8_t data[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x3F};
    [[maybe_unused]] size_t offset = 0;
